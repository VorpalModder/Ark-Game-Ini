...
- **Game.Minimalist.ini**  
  ...
  <pre style="overflow-x:auto; white-space:nowrap;">
    ActiveMods=1565015734,731604991,821530042,1837445660,1404697612,1195125628,1251632107,1609138312,1814953878,1957185915,2016338122,2121156303,506506101,741203089,880871931,945065004,817096835,2788780899,898049820,1231538641,558651608,1445181373,1522327484,1426087933,2959693896
  </pre>
...
2. Rename the file to **`Game.ini`**.  
3. Place it in the correct configuration folder for your server or single‑player game:  
   - **Dedicated server**: `ShooterGame/Saved/Config/WindowsServer/`  
   - **Single player**: `ShooterGame/Saved/Config/WindowsNoEditor/`  
4. Restart the game or server to apply the changes.  
